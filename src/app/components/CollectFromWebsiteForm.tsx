    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl w-full max-w-md lg:max-w-lg 2xl:max-w-xl mx-auto ">
      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          >
            <option value="From URL" className='dark:bg-gray-800'>From URL</option>
            <option value="From API" className='dark:bg-gray-800'>From API</option>
            <option value="From HTML" className='dark:bg-gray-800'>From HTML</option>
          </select>
